...
const createMessage = (domain: string, port: string, email_token: string) => {
	...
	<p class="block"><a href="https://${domain}${port}/verify_email/${email_token}">https://${domain}${port}/verify_email/${email_token}</a></p>
