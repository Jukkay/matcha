		...
		<div className="columns is-centered">
			<div className="column is-three-quarters mt-6 pt-6 content">
				...
				<p>
					...
					for the use of Matcha ltd's Website, located at
					https://matcha.jukka.codes.
				</p>

				<p>
					By accessing this website we assume you accept these terms
					and conditions. Do not continue to use Matcha if you do not
				...
				<p>
					...
					agreed to use cookies in agreement with the Matcha ltd's
					Privacy Policy.{' '}
				</p>
				...
				<p>
					Unless otherwise stated, Matcha ltd and/or its licensors own
					the intellectual property rights for all material on Matcha.
					All intellectual property rights are reserved. You may
					access this from Matcha for your own personal use subjected
				...
				<ul>
					...
					<li>Sell, rent or sub-license material from Matcha</li>
					<li>Reproduce, duplicate or copy material from Matcha</li>
				...
				<p>
					...
					the website. Matcha ltd does not filter, edit, publish or
					review Comments prior to their presence on the website.
					Comments do not reflect the views and opinions of Matcha
					ltd,its agents and/or affiliates. Comments reflect the views
					and opinions of the person who post their views and
					opinions. To the extent permitted by applicable laws, Matcha
					ltd shall not be liable for the Comments or for any
				...
				<p>
					Matcha ltd reserves the right to monitor all Comments and to
				...
				<p>
					You hereby grant Matcha ltd a non-exclusive license to use,
				...
				<p>
					...
					compensates the absence of Matcha ltd; and (d) the link is
				...
				<p>
					...
					inform us by sending an e-mail to Matcha ltd. Please include
				...
				<p>
					No use of Matcha ltd's logo or other artwork will be allowed
