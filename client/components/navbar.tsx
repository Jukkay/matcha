    ...
    <nav className="navbar" role="navigation" aria-label="main navigation">
      <div className="navbar-brand">
        <a className="navbar-item pt-3" href="/">
          <span className="icon is-medium">
            <IconContext.Provider value={{ size: '1.2rem', className: 'react-icons' }}>
              <div>
                <FaHeart />
              </div>
        ...
        <a role="button" className="navbar-burger" aria-label="menu" aria-expanded="false" data-target="navbar-burger-button">
      ...
      <div className="navbar-menu is-hidden mobile-menu" id="navbar-mobile">
        <div className="navbar-end">
          <a className="navbar-item" href="/camera">Take picture</a>
          <a className="navbar-item" href="/newpost">New post</a>
          <a className="navbar-item" href="/profile">Profile</a>
          <a className="navbar-item" href="/controlpanel">Control panel</a>
      ...
      <div className="navbar-menu">
        <div className="navbar-start">
          <a className="navbar-item" href="/camera">Link 1</a>
          <a className="navbar-item" href="/newpost">Link 2</a>
        </div>
        <div className="navbar-end">
          ...
          <div className="navbar-item" id="profile">
            <a className="navbar-item" href="/profile">
              ...
              <figure className="image">
                <img className="is-rounded" src="https://placeimg.com/80/80/people" />
              </figure>
            </a>
          </div>
